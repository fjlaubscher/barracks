...
// battles
const CreateBattle = lazy(() => import('./pages/battle/create'));
const AIBattle = lazy(() => import('./pages/battle/ai'));
const Battle = lazy(() => import('./pages/battle'));
const ScoreBattle = lazy(() => import('./pages/battle/score'));
...
const AppRoutes = () => {
  ...
  return (
    <Routes location={deferredLocation}>
      ...
      <Route path="/battle/:key/score" element={<ScoreBattle />} />
      <Route path="/battle/:key/ai" element={<AIBattle />} />
      <Route path="/battle/:key" element={<Battle />} />
      <Route path="/battle" element={<CreateBattle />} />
